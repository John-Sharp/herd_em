...
convert 1.png 2.png 3.png 2.png -background 'rgba(0,0,0,0)' -rotate 90 -resize 12.5% -colors 2 E_walking.png
...
convert 0.png -background 'rgb(255,255,255)' -alpha remove -rotate 315 -resize 12.5% NW_still.png
convert 1.png 2.png 3.png 2.png -background 'rgb(255, 255, 255)' -alpha remove -rotate 315 -resize 12.5% +append NW_walking.png
